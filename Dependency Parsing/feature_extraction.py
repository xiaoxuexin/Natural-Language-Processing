...
class DataReader(object):
    ...
    def read_data(self, data_lines):
        ...
        if len(token_lines) > 0:
            data_objects.append(self.read_conll(token_lines))
        # print(data_objects[0].get_transition_from_current_state())
        return data_objects
...
def load_datasets(load_existing_dump=True):
    ...
    # train_lines = open('train.conll', 'r').readlines()
    # valid_lines = open('dev.conll', 'r').readlines()
    # test_lines = open('test.conll', 'r').readlines()
